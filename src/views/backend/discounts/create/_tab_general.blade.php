...
<div class="form-group row required">
  <div class="col-sm-6">
    ...
    <label for="discount_highlight">
        <input type="checkbox" class="boolean_checkbox_input" id="discount_highlight" value="1" name="discount_highlight"/> Tonen in winkelmand?
    </label>
  </div>
  <div class="col-sm-6">
    ...
    <label for="discount_active">
        <input type="checkbox" class="boolean_checkbox_input" id="discount_active" value="1" name="discount_active" checked/> Actief?
    </label>
  </div>
</div>
