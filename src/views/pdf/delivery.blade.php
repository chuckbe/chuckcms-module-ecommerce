...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>LEVERBON #{{ $order->json['order_number'] }}</title>
  ...
  <body>
    ...
    <footer>
      ...
      Vragen bij deze leverbon? Contacteer ons op {{ ChuckSite::getSetting('company.email') }}
    ...
    <main>
      <div id="details">
        <div style="width:auto;height:auto;margin: 0 auto;">
          <div id="client">
            <div class="to">LEVERBON VOOR:</div>
          ...
          <div id="invoice">
            <h1 style="color:#000;">LEVERBON {{ $order->json['order_number'] }}</h1>
            <div class="date">besteld op: {{ date('d/m/Y', strtotime($order->created_at)) }}</div>
          </div>
        </div>
      </div>
      <br><br>
